...
- **[video_processing.md](documentation/video_processing.md)** - Future enhancements document detailing how to expand the project to use videos instead of images.
